export type Education = {
  ...
  export const education: Education[] = [
    {
      ...
      description: `
  Worked on many practical projects using Arduino microcontrollers and graphical programming applications.
  
  Contributed as a UX/UI Designer to Pocket Code, a coding-for-kids application for Windows Phone.
  ...
  Learned user experience design through various real-world projects and used programming and visual programming tools to create small applications.
  `,
      technologies: [
        "Arduino",
        "Node.js",
  ...
  Also worked as a graphic design intern in an advertising agency.
  `,
      technologies: [
        "Graphic Design",
